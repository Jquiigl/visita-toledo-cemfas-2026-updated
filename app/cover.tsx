...
export default function Cover({initialLanguage='es'}:{initialLanguage?:LanguageCode}){
  ...
  return <main className="toledo-cover" lang={language} dir={readingDirection(language)}>
    <img className="cover-city" src="/images/places/alcazar.jpg" alt="" fetchPriority="high"/>
    <div className="cover-inner">
      ...
      <section className="cover-content" aria-labelledby="cover-title">
        ...
        <h1 id="cover-title" dir="ltr">TOLEDO <span>Updated</span></h1>
      ...
      <footer className="cover-footer"><span>{ui[language].noticeTitle}</span><span dir="ltr">TOLEDO UPDATED · V2</span></footer>
    </div>
  </main>;
}
